...
export class BaseGridController extends GridJs {
    ...
    setUp(): this {
        ...
        let elements : GridElement[] = [
            ...
            new GridSeparatorVertical('VS2',viewBaseGridVSeparator,false),
            new GridElement('documentation',viewBaseGridElement),
            new GridSeparatorHorizontal('HS1',viewBaseGridHSeparator),
            new GridElementWithView(new LogsGridController("logsGridController").id,"bottomLogs",undefined),
        ...
        this.gridDesing = {
            ...
            new GridElementDesign("0","px",true,[{resize: 40,range: {from:0,to:200}},{resize: 350,range: {from:200,to:350}}],{min:0,max:700})], 
